// api/bee.js — fetch-only, streams image/* bytes
...
const QUERIES = [
  ...
  "bee collecting nectar macro photo",
  "bee in flight macro photography",
  "bee on flower close up photo",
  "wild bee macro photo",
  "bee portrait macro nature photography"
];

const FALLBACKS = [
  "https://upload.wikimedia.org/wikipedia/commons/6/6b/Honey_bee_(Apis_mellifera)_on_Wild_Ligularia_dentata.jpg",
  "https://upload.wikimedia.org/wikipedia/commons/1/17/Bee_on_a_flower.jpg",
  "https://upload.wikimedia.org/wikipedia/commons/a/a8/Bumblebee_Macro.jpg",
  "https://upload.wikimedia.org/wikipedia/commons/f/f3/Honeybee_on_Lavender.jpg"
];
...
export default async function handler(req,res){
  ...
  if(!serpKey){
    ...
    res.setHeader("Content-Disposition", `inline; filename=\"bee.${data.ext}\"`);
  ...
  try{
    ...
    return res.status(404).json({ ok:false, error:"no_usable_bee_found" });
  }
}
